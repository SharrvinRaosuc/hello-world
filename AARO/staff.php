    ...
    <div class="staff">
      ...
      <div class="staff_data">
        <table width="100%" border="0" cellpadding="3" cellspacing="0">
          <tr>
            <td width="45" valign="top"><strong>姓名：</strong></td>
            <td valign="top"><?php if($row_dir['ch_name']!="") echo $row_dir['ch_name']; else echo $row_dir['en_name']; ?></td>
          </tr>
          <tr>
            <td valign="top"><strong>职位：</strong></td>
            <td valign="top"><?php echo $row_dir['ch_position']; ?></td>
          </tr>
          <tr>
            <td valign="top"><strong>分机：</strong></td>
            <td valign="top"><?php if($row_dir['ext_no']!="") echo $row_dir['ext_no']; else echo "-"; ?></td>
          </tr>
          <tr>
            <td valign="top"><strong>电邮：</strong></td>
