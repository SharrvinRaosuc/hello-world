...
$query_news = "select * from news where status = '1' and department_id = '4' and category_id = '2' and (language = 'ch' or language = 'ce') order by created_date desc ";
...
<div class="container">
  ...
  <div class="right">
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" class="pages">
      <tr>
        <td><div class="page" title="第一页"><a href="<?php echo url_set_value($url,"page",1); ?>">&lt;&lt;</a></div>
          <div class="page" title="前一页"><a <?php if($page>1) echo "href=\"".url_set_value($url,"page",$pre)."\""; ?>>&lt;</a></div>
          <?php for($i=$start;$i<=$end;$i++){ ?>
          <div class="page <?php if($i==$page) echo "c_page"; ?>"><a <?php if($i!=$page) echo "href=\"".url_set_value($url,"page",$i)."\"";?>><?php echo $i; ?></a></div>
          <?php }?>
          <div class="page" title="下一页"><a <?php if($page<$pages) echo "href=\"".url_set_value($url,"page",$next)."\""; ?>>&gt;</a></div>
          <div class="page" title="最后一页"><a href="<?php echo url_set_value($url,"page",$pages); ?>">&gt;&gt;</a></div></td>
      </tr>
    </table>
    <?php } ?>
    <p>&nbsp;</p>
